...
const Main = () => {
  ...
  return (
    <div className='main'>
      <div className="nav">
        <p>Gemini</p>
        <img src={assets.ic2} alt="" />
        </div>  
        <div className="main-container">
            {!showResult
            ?<>
                <div className="greet">
                <p><span>Hello, Krishna</span></p>
            ...
            <div className="main-bottom">
                <div className="search-box">
                    <input onChange={(e)=> setInput(e.target.value)} onKeyPress={handleKeyPress} value={input} type="text" placeholder='Ente a prompt here'/>
            ...
            Gemini may display inaccurate info, including about people, so double-chek its response. Your privacy and Gemini Apps
        </p>
        </div>
